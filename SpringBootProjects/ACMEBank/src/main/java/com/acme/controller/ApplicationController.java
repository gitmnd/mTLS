...
public class ApplicationController {
    ...
    @GetMapping("/")
    public String getACMEBank(){
        return "You are connected to ACME Bank";
    }

    /*
    * Calling acme nginx server , which will send the request to NB
    * */
    @GetMapping("/call-external")
    public ResponseEntity<String> callExternalApi() {
        System.out.println("Invoked call-external..");
        String externalUrl = "http://127.0.0.1:9000";
